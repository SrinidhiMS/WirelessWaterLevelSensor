...
#ifndef STASSID
#define STASSID "YOURWiFIAP"
#define STAPSK  "YOURAPpassword"
#endif
...
void loop() {
  ...
  if (req.indexOf("/gpio/0") != -1) {
    ...
    client.print("<TITLE />Sudhama's meta-refresh Water Level Sensor Page</title>");
    client.print("</head>");
    client.println("<BODY>");
    client.print("Based on NodeMCU + HCSR04 over Wifi");
    client.println("<br />");
    ...
    client.println("<br />");
    client.println("<br />");
    client.print("HTTP/1.1 Distance :");
    disttoH2O =distanceSensor.measureDistanceCm();
    client.print(disttoH2O);
    client.print(" in Centimeters ");
    client.println("<br />");
    client.println("<br />");
    if (disttoH2O< 0.0)     client.print(" !!!!SENSOR DISCONNECTED!!!!");
    else if (disttoH2O< 30.0)     client.print(" 95%:     FULL");
    else if (disttoH2O< 45.0)     client.print(" 80%:    Nearly FULL");
    else if (disttoH2O< 40.0)     client.print(" 70%:     >> Three Quarters filled ");
    else if (disttoH2O< 50.0)     client.print(" 65%:     >> 2/3 filled 1/3 empty");
    else if (disttoH2O< 60.0)     client.print(" 50%:     >> Halfway there");
    else if (disttoH2O< 70.0)     client.print(" 35%:     >> 1/3 filled 2/3 empty");
    else if (disttoH2O< 80.0)     client.print(" 25%:     >> Quarter filled");
    else if (disttoH2O< 100.0)     client.print(" 10%:     >> Nearly Empty");
    else  client.print(" 00%:     TANK DRY");
